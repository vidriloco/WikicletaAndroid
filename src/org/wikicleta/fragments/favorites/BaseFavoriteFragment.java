...
public class BaseFavoriteFragment extends Fragment implements FavoriteFragmentInterface {
    ...
    protected void toggleViews(ArrayList<LightPOI> objects) {
		if(objects == null || objects.isEmpty()) {
			...
			((TextView) this.getView().findViewById(R.id.no_favorited_items)).setTypeface(AppBase.getTypefaceStrong());
		} else {
	...
	public void viewWillAppear() {
		this.getParentActivity().fetchUserFavoritedRoutes();		
	}
