...
public class MenuOptionsListAdapter extends ArrayAdapter<Integer> {
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
		View rowView = inflater.inflate(R.layout.layer_item, parent, false);
	    ...
	    if(values[position]==Constants.BIKE_SHARING_OVERLAY) {
	    	...
	    	imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.toggle_menu_bike_sharing_icon));
	    	...
	    	imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.toggle_menu_bike_repair_icon));
	    	...
	    	imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.toggle_menu_bike_parking_icon));
	    } else if(values[position]==Constants.TIPS_OVERLAY) {
	    	textView.setText(context.getResources().getString(R.string.toggle_menu_tips));
	    	imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.toggle_menu_tips_icon));
	    	...
	    	imageView.setImageDrawable(context.getResources().getDrawable(R.drawable.toggle_menu_routes_icon));
	    }
