...
public class DateTimeUtils extends DateUtils {
    ...
    private static String mTimestampLabelPastDay;
    ...
    */
    public static DateTimeUtils getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            mTimestampLabelHourAgo = context.getResources().getString(R.string.timestamp_hour_ago);
            mTimestampLabelPastDay = context.getResources().getString(R.string.timestamp_past_day);
        }
        return instance;
    }
   ...
   public String getTimeDiffString(long timedate) {
       ...
       if (hours > 0 && hours < 12) {
           ...
           return String.format(mTimestampLabelPastDay, weekdays[endDateTime.get(Calendar.DAY_OF_WEEK)]);
       } else {
